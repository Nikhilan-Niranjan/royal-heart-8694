...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/royal-heart-8694
```

A live public deployment of this template is available at [https://royal-heart-8694.templates.workers.dev](https://royal-heart-8694.templates.workers.dev)
